...
export default class PostListItem extends Component {
    ...
    //конструктор нициализирует состояние компонента и привязывает метод вычеркивание выполненной задачи. 
    constructor(props) {
        super(props);
        this.state = {
            crossedOut: false
    ...
    //меняет состояние элемента на противоположное
    toggleCrossOut() {
    ...
    //Отображает пост с кнопками для управления состояниями
    render() {
